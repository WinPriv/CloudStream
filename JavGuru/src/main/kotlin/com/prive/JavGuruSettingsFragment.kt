 ...
 */
class JavGuruSettingsFragment(
    private val plugin: JavGuruPlugin,
    ...
    override fun onCreateView(
        ...
        val layoutId = plugin.resources?.getIdentifier("fragment_javguru_settings", "layout", BuildConfig.LIBRARY_PACKAGE_NAME)
        return layoutId?.let {
